...
def AvailableTrains():
    ...
    mn = mysql.connector.connect(host="localhost", user='root',
                                 password='Sangeeta@5785', database="railway")
    cur = mn.cursor()
    ...
    while True:
        ...
        if ask in ["Y", "y"]:
            ...
            try:
                ...
                #query = 'INSERT INTO train_info VALUES(%d,%s,%s,%s,%s,%d,%s)', (train_no, Name, Mobile, adhaar, date, id, Class)
                cur.execute(query)
            except DataError:
...
def CancelBooking():
    ...
    print("Please use the Show my Bookings Optionto get the Unique ID of the Booking you want to Cancel!")
